        ...
        >
          ...
          <div className="mb-4 p-3 bg-green-50 rounded-lg border border-green-200">
            <div className="flex items-center">
              ...
              <div>
                <p className="font-medium text-green-800">Coming Soon: WhatsApp Integration</p>
                <p className="text-sm text-green-700">Get notifications and communicate directly via WhatsApp</p>
              </div>
            </div>
          </div>
  ...
  return (
    <div className="flex flex-col h-screen bg-white">
      ...
      <div className="p-4 border-b">
        ...
        <div className="mt-2 mb-3 p-3 bg-green-50 rounded-lg border border-green-200 flex items-start">
          <div className="shrink-0 bg-green-500 text-white p-1 rounded-full mr-3">
          ...
          <div>
            <h3 className="font-semibold text-green-800">WhatsApp Integration Coming Soon</h3>
            <p className="text-sm text-green-700">
              Soon, you'll be able to receive car booking updates directly on WhatsApp!
            </p>
          </div>
        </div>
